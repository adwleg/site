                ...
                <div class="blog-wrapper">
                    <div class="blog-nav">
                        ...
                        <div class="blog-switcher-wrapper">
                            <a data-rel="blog-list" data-unrel="blog-grid" class="blog-switcher <?php echo esc_attr($blog_style == 'blog-list' ? 'blog-switcher-active' : '')  ?>" href="javascript:;"><?php _e("List","cupid"); ?><i class="fa fa-th-list"></i></a>
                            <a data-rel="blog-grid" data-unrel="blog-list" class="blog-switcher <?php echo esc_attr( $blog_style == 'blog-grid' ? 'blog-switcher-active' : '') ?>" href="javascript:;"><?php _e("Grid","cupid"); ?><i class="fa fa-th-large"></i></a>
                        </div>
                        <?php endif; ?>
                    </div>
